...
import (
	...
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/ocdav/config"
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/ocdav/errors"
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/ocdav/net"
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/ocdav/prop"
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/ocdav/spacelookup"
	"github.com/opencloud-eu/opencloud/services/webdav/pkg/xs"
...
func mdToPropResponse(ctx context.Context, pf *XML, md *provider.ResourceInfo, publicURL, ns string, linkshares map[string]struct{}, returnMinimal bool, urlSigner signedurl.Signer) (*ResponseXML, error) {
	...
	if pf.Allprop != nil {
		...
		if md.Checksum != nil {
			...
			checksums.WriteString(strings.ToUpper(string(xs.GRPC2PKGXS(md.Checksum.Type))))
