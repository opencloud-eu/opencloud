...
type Thumbnail struct {
	...
	TransferSecret        string            `yaml:"transfer_secret" env:"THUMBNAILS_TRANSFER_TOKEN,file" desc:"The secret to sign JWT to download the actual thumbnail file." introductionVersion:"1.0.0"`
