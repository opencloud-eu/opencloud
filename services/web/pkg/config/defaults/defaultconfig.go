...
func Sanitize(cfg *config.Config) {
	...
	if cfg.Web.Config.Options.AccountEditLink != nil && cfg.Web.Config.Options.AccountEditLink.Href == "" {
		cfg.Web.Config.Options.AccountEditLink = nil
	}
	// remove Editor parent if no value is set
	if cfg.Web.Config.Options.Editor != nil && !cfg.Web.Config.Options.Editor.AutosaveEnabled {
		cfg.Web.Config.Options.Editor = nil
	}
	// remove FeedbackLink parent if no value is set
	if cfg.Web.Config.Options.FeedbackLink != nil && cfg.Web.Config.Options.FeedbackLink.Href == "" &&
	...
	if cfg.Web.Config.Options.Upload != nil && cfg.Web.Config.Options.Upload.CompanionURL == "" {
		cfg.Web.Config.Options.Upload = nil
	}
	// remove Embed parent if no value is set
	if cfg.Web.Config.Options.Embed != nil && cfg.Web.Config.Options.Embed.Enabled == "" &&
