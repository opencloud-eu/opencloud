...
type Debug struct {
	...
	Token  string `yaml:"token" env:"GROUPS_DEBUG_TOKEN,file" desc:"Token to secure the metrics endpoint." introductionVersion:"1.0.0"`
...
type LDAPDriver struct {
	...
	BindPassword             string          `yaml:"bind_password" env:"OC_LDAP_BIND_PASSWORD;GROUPS_LDAP_BIND_PASSWORD,file" desc:"Password to use for authenticating the 'bind_dn'." introductionVersion:"1.0.0"`
...
type OwnCloudSQLDriver struct {
	...
	DBPassword         string `yaml:"db_password" env:"GROUPS_OWNCLOUDSQL_DB_PASSWORD,file" desc:"Password for the database user." introductionVersion:"1.0.0"`
