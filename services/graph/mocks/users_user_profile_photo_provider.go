...
// SyncPhotoFromURL provides a mock function with given fields: ctx, userID, rawURL
func (_m *UsersUserProfilePhotoProvider) SyncPhotoFromURL(ctx context.Context, userID string, rawURL string) error {
	ret := _m.Called(ctx, userID, rawURL)

	if len(ret) == 0 {
		panic("no return value specified for SyncPhotoFromURL")
	}
...
// UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncPhotoFromURL'
type UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call struct {
	*mock.Call
}

// SyncPhotoFromURL is a helper method to define mock.On call
//   - ctx context.Context
//   - userID string
//   - rawURL string
func (_e *UsersUserProfilePhotoProvider_Expecter) SyncPhotoFromURL(ctx interface{}, userID interface{}, rawURL interface{}) *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call {
	return &UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call{Call: _e.mock.On("SyncPhotoFromURL", ctx, userID, rawURL)}
}

func (_c *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call) Run(run func(ctx context.Context, userID string, rawURL string)) *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call) Return(_a0 error) *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call) RunAndReturn(run func(context.Context, string, string) error) *UsersUserProfilePhotoProvider_SyncPhotoFromURL_Call {
	_c.Call.Return(run)
	return _c
}
