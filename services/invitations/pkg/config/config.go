...
type Keycloak struct {
	...
	ClientSecret       string `yaml:"client_secret" env:"OC_KEYCLOAK_CLIENT_SECRET;INVITATIONS_KEYCLOAK_CLIENT_SECRET,file" desc:"The client secret to use in authentication." introductionVersion:"1.0.0"`
