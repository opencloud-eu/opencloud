...
type Tracing struct {
	...
	Type      string `yaml:"type" env:"OC_TRACING_TYPE" desc:"Deprecated: legacy tracing type." introductionVersion:"1.0.0" deprecationVersion:"2.0.0" deprecationInfo:"Use OC_TRACES_EXPORTER or OTEL_TRACES_EXPORTER instead."`
	Endpoint  string `yaml:"endpoint" env:"OC_TRACING_ENDPOINT" desc:"Deprecated: legacy tracing endpoint." introductionVersion:"1.0.0" deprecationVersion:"2.0.0" deprecationInfo:"Configure OTEL_EXPORTER_OTLP_ENDPOINT instead."`
	Collector string `yaml:"collector" env:"OC_TRACING_COLLECTOR" desc:"Deprecated: legacy tracing collector endpoint." introductionVersion:"1.0.0" deprecationVersion:"2.0.0" deprecationInfo:"Configure OTEL_EXPORTER_OTLP_ENDPOINT/OTEL_EXPORTER_OTLP_PROTOCOL instead."`
}
